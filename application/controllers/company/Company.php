...
class Company extends MY_Controller {
	...
	public function index(){
            ...
            $data['title']   = 'Профиль компании';
            $data['view']    = 'company/company';
            
            $this->load->view('layout', $data);
	}

        public function services() {
            //$data['company'] = $this->company_model->get_services($this->session->userdata('company_id'));
            //$data['title']   = '';
            //$data['view']    = 'company/services';
        ...
        public function save_common() {
            ...
            if(!empty($_FILES['logo']['name'])) {
                ...
                if($result['status'] == 1) {
                    ...
                    redirect(base_url('company/company'), 'refresh');
                }
            }
