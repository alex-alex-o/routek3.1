    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?= base_url('admin/machines/'); ?>" class="btn bg-deep-orange waves-effect pull-right">Парк машин</a>
            </div>
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <?php echo form_open(base_url('admin/machines/add'), 'class="form-horizontal"');  ?> 
