    ...
    <div class="row clearfix">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-deep-orange hover-expand-effect">
                ...
                <div class="content">
                    <div class="text">Компаний</div>
                    <div class="number count-to" data-from="0" data-to="<?= $companies_count; ?>" data-speed="1000" data-fresh-interval="20"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-light-green hover-expand-effect">
                ...
                <div class="content">
                    <div class="text">Заказов</div>
                    <div class="number count-to" data-from="0" data-to="<?= $orders_count; ?>" data-speed="1000" data-fresh-interval="20"></div>
                </div>
            </div>
        </div>
    </div>
