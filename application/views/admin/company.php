        ...
        <div class="card">
            ...
            <div class="body">
                <ul class="nav nav-tabs tab-nav-right" role="tablist">
                    ...
                    <li role="presentation"><a href="#map"      data-toggle="tab">Карта</a></li>
                </ul>
                                ...
                                <?php echo form_open(base_url('admin/company'), 'id = "covid-form" class="form-horizontal"' )?> 
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                            <label for = "is_free_medic_production">Готов бесплатно изготавливать изделия для медицинских целей</label>
                                        </div>

                                        <div class="demo-switch">
                                            <div class="switch">
                                                <label><input type="checkbox" name = "is_free_medic_production" <?=($company['is_free_medic_production'] ? "checked" : ""); ?> ><span class="lever switch-col-indigo"></span></label>
                                            </div>
                                        </div>
                                    </div>                               
