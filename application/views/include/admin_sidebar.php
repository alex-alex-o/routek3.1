...
<?php if(false): ?>
            <li class="nav-item">
                <a class="nav-link text-light" href = "<?= base_url('admin/dashboard');?>">
            ...
            <li class="nav-item ">
                <a class="nav-link text-light" href="<?= base_url('admin/company/index');?>">
...
<?php endif; ?>
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="<?= base_url('admin/premoderation/index'); ?>">
...
<?php if(false): ?>            
            <li class="nav-item">
                <a class="nav-link text-light" href="<?= base_url('admin/users'); ?>">
