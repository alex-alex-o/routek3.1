        ...
        <ul class="list">
          <li class="header">МЕНЮ</li>
              ...
              <li id = "offers">
                  ...
                  <ul class="ml-menu">
                      <li id="sent">
                          <a href="<?= base_url('user/offers/sent'); ?>">Разосланные на производства</a>
                      </li>                      
                      <li id="company-accepted">
                          <a href="<?= base_url('user/offers/company-accepted'); ?>">Предложения производств</a>
                      </li>
                      <li id="accepted">
                          <a href="<?= base_url('user/offers/accepted'); ?>">Подтвержденные мной</a>
                      </li>
                      <?php if (false): ?>
                      <li id="all-offers">
                          <a href="<?= base_url('user/offers/all-offers'); ?>">Все</a>
                      </li>
                      <?php endif; ?>
                  </ul>
              </li>
              ...
              <li id = "orders">
                  ...
                  <ul class="ml-menu">
                      <li id="progress">
                          <a href="<?= base_url('user/orders/progress'); ?>">В работе</a>
                      </li>

                      <li id="completed">
                          <a href="<?= base_url('user/orders/completed'); ?>">Выполненные</a>
                      </li>

                      <li id="all-orders">
                          <a href="<?= base_url('user/orders/all-orders'); ?>">Все</a>
                      </li>
                  </ul>
