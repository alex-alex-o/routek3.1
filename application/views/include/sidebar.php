        ...
        <ul class="list">
          <li class="header">МЕНЮ</li>
              ...
              <?php if (false): ?>
                  <li id="users">
                      ...
                      <ul class="ml-menu">
                          ...
                          <li id="profile">
                              <a href="<?= base_url('admin/profile'); ?>">Профиль</a>
                          </li>
                      </ul>
                  </li>
              <?php endif; ?>
              ...
              <li id = "company">
                  ...
                  <ul class="ml-menu">
                      <li id="company">
                          <a href="<?= base_url('admin/company/common'); ?>">Профиль организации</a>
                      </li>

                      <li id="machines">
                          <a href="<?= base_url('admin/company/machines'); ?>">Парк машин</a>
                      </li>

                      <li id="finishes">
                          <a href="<?= base_url('admin/company/finishes'); ?>">Финишная обработка</a>
                      </li>
                      
                      <li id="products">
                          <a href="<?= base_url('admin/company/media/products'); ?>">Примеры продукции</a>
                      </li>

                      <li id="certificates">
                          <a href="<?= base_url('admin/company/media/certificates'); ?>">Сертификаты</a>
                      </li>

                      <li id="gallery">
                          <a href="<?= base_url('admin/company/media/gallery'); ?>">Галерея</a>
                      </li>
              ...
              <li id = "orders">
                  ...
                  <ul class="ml-menu">
                      <li id="offers">
                          <a href="<?= base_url('admin/orders/offers'); ?>">Предложения</a>
                      </li>

                      <li id="new">
                          <a href="<?= base_url('admin/orders/new'); ?>">Новые</a>
                      </li>
                      
                      <li id="progress">
                          <a href="<?= base_url('admin/orders/progress'); ?>">В работе</a>
                      </li>

                      <li id="completed">
                          <a href="<?= base_url('admin/orders/completed'); ?>">Выполненные</a>
                      </li>

                      <li id="all">
                          <a href="<?= base_url('admin/orders/all'); ?>">Все заказы</a>
                      </li>
                  </ul>
