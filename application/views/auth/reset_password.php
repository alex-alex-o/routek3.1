...
<head>
    ...
    <title><?=isset($title)?$title. ' - Routek 2.0' : 'Routek 2.0' ?></title>
    <!-- Favicon-->
        ...
        <div class="card">
            <div class="body">
                <?php echo form_open(base_url('auth/reset-password/'.$reset_code), 'class="login-form" '); ?>
                    <div class="msg">Сбросить пароль</div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">lock</i>
                        </span>
                        <div class="form-line">
                            <input type="password" class="form-control" name="password" placeholder="Новый пароль" required>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <input type="submit" name="submit" id="submit" class="btn btn-block btn-success waves-effect" value="Сбросить">
                        </div>
                    </div>
                <?php echo form_close(); ?>
            </div>
