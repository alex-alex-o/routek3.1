        ...
        <div class="card">
            <div class="body">
                <?php echo form_open(base_url('auth/forgot-password'), 'class="login-form" '); ?>
                    <div class="msg">Введите ваш email для получения инструкций по сбросу пароля</div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <input type="submit" name="submit" id="submit" class="btn btn-block btn-success waves-effect" value="Восстановить пароль">
                        </div>
                    </div>
                    <div class="m-t-25 align-center">
                        <a href="<?= base_url('auth/login'); ?>">Вспомнили пароль? Вход </a>
                    </div>
                <?php echo form_close(); ?>
            </div>
        </div>
