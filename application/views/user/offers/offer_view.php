...
<div class="row clearfix">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <?php echo form_open(base_url('user/offers/send_to_company/' . $offer['id'] . '/' . $order['id']), 'class="form-horizontal"')?> 
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id = "lead_time" name = "lead_time" class="form-control text-center" value="<?= $offer['lead_time']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>   
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea readonly rows="4" name="comment" class="form-control" placeholder="Описание"><?= $offer['comment']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>           
                
                    <?php if(!$offer["commited_by_user"] && $offer["answered_by_company"]): ?>
                        <div class="row clearfix">
                            <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                <input type = "submit" name = "submit" value = "ПРИНЯТЬ ПРЕДЛОЖЕНИЕ" class="btn btn-primary m-t-15 waves-effect">
                            </div>
                        </div>
                    <?php endif; ?>
