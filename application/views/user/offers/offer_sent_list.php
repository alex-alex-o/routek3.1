                ...
                <div class="table-responsive">
                  <table id = "na_datatable" class = "table table-striped table-hover dataTable">
                    <thead>
                      <tr>
                        <th>Название</th>
                        <th>Количество разосланых заявок</th>
                        <th>Дата</th>
...
<script type="text/javascript">
  //---------------------------------------------------
    var table = $('#na_datatable').DataTable( {
        ...
        "serverSide": true,
        "searching": false,
        "ajax": "<?=base_url('user/offers/sent_datatable_json/' . $this->session->userdata('user_id') . '/' . $status_id)?>",
        "order": [[2,'desc']],
        "columnDefs": [
            { "targets": 0, "name": "name",       'searchable':true,  'orderable' : true},
            { "targets": 1, "name": "count", 'searchable':false, 'orderable' : true},
