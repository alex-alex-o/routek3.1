                ...
                <div role="tabpanel" class="tab-pane fade in active" id = "actual">
                    <div class="cards">
                        <?php foreach($actualOrders as $order): ?>
                            <?php
                                $offerReadOnly = "";
                                if ($order["answered_by_company"] || $order["refused_by_company"]) {
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-3">
                                                ...
                                                <div class = "row">
                                                    ...
                                                    <div class="col-xs-8">
                                                        <?php foreach($files[$order["id"]] as $file): ?>
                                                            <a href = "<?php echo base_url() . $file['path'] . '/' . $file['file_name']; ?>"><?php echo $file['orig_name']; ?></a><br />
                                                        <?php endforeach; ?>
                                                    </div>
                                                </div>                                                 
                                            </div>
                                        ...
                                        <div class = "col-sm-12">
                                            <div class="collapse" id = "offers_<?php echo $order["id"]; ?>">
                                                <div class="well">
                                                    ...
                                                    <?php echo form_open(base_url('company/offers/send_to_user/' . $order['offer_id']), 'class="form-horizontal"')?> 
                                                        <div class = "row">
                                                            <div class = "col-lg-4">
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <div class="form-line">
                                                                                <input <?= $offerReadOnly; ?> type="text" id = "lead_time" name = "lead_time" class="form-control text-center" value="<?= $order['lead_time']; ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class = "row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <div class="form-line">
                                                                                <input <?= $offerReadOnly; ?> type="text" id = "cost" name = "cost" class="form-control text-center" value="<?= $order['offer_cost']; ?>">
                                                                            </div>                                                    
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-8">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <textarea <?= $offerReadOnly; ?> rows="4" name="comment" class="form-control" placeholder="Описание"><?= $order['offer_comment']; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>           
                                                        ...
                                                        <?php if (empty($offerReadOnly)):?>
                                                            <div class="row clearfix">
                                                                ...
                                                                <div class="col-lg-6 align-center">
                                                                    <a href = "/company/offers/refuse/<?= $order['offer_id']; ?>" class="btn btn-warning">ОТКАЗАТЬСЯ</a>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
